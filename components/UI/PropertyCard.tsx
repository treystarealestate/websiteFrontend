        ...
        <Card className="rounded-4 bg-transparent">
          <Link href={`/off-plan/${project?.slug}`}>
            <Card.Img 
              className="projImg" 
              variant="top" 
              src={project.image || "/assets/frontend/images/default-image.jpg"} 
              alt={project.title} 
            />
            ...
            <div className="d-flex justify-content-start my-2">
              <div className="my-auto">
                <p className="text-desc mb-0">
                  <img 
                    src="/assets/frontend/images/icons/bedroom.png" 
                    alt="bedroom" 
                    className="img-fluid" 
                    width="30px" 
                  />
                  &nbsp;<span className="align-middle">{project.bedrooms} BR | {project.accommodation}</span>
                </p>
              </div>
            </div>
              ...
              <div className="my-auto">
                {project.title && (
                  <button 
                    ...
                    onClick={() => openModal(project.title, '', "Pre-Register Now")}
                  >
                    <span className="align-top">Pre Register </span>&nbsp;
                    <i className="bi bi-arrow-up-right-circle-fill align-top text-gold"></i>
                  </button>
                )}
              </div>
            </div>
